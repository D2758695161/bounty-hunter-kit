...
const SEED_TASKS: Task[] = [
  ...
  {
    id: "apr19-1",
    title: "🔥 AI Agent Memory Long-Term System — Supabase pgvector + Claude Integration",
    titleEn: "🔥 AI Agent Memory Long-Term System — Supabase pgvector + Claude",
    description: "为 AI Coding Agent 构建持久化记忆系统：pgvector 向量存储会话摘要+关键事实，按时间/主题/重要性检索，使 Claude/Agent 跨会话保持上下文记忆。已在生产环境验证。",
    descriptionEn: "Build persistent memory system for AI Coding Agent: pgvector stores session summaries + key facts, retrievable by time/topic/importance, enabling Claude/Agent to maintain context across sessions. Production-validated.",
    type: "long-term",
    budget: 22000,
    currency: "CNY",
    skills: ["Supabase", "pgvector", "Python", "Claude API", "AI Agent", "Memory"],
    deadline: "2026-05-15",
    posterName: "MemoryAI Lab",
    posterAvatar: "🧠",
    contactWechat: "memoryai_lab",
    contactEmail: "lab@memoryai.io",
    requirements: "有 pgvector/向量库实际项目；有 AI Agent 对话管理经验；熟悉 Supabase Edge Functions",
    requirementsEn: "pgvector/vector DB hands-on; AI agent conversation management; Supabase Edge Functions familiar",
  ...
  {
    id: "apr19-2",
    title: "🔥 L402 Lightning Bridge PoC — SatGate Bounty (Stellar USDC)",
    titleEn: "🔥 L402 Lightning Bridge PoC — SatGate Bounty (Stellar USDC)",
    description: "实现 L402 闪电网络桥接概念验证：支持 Stellar USDC 跨链转账、HTLC 原子交换、L402 微支付通道。SatGate 官方 Bounty，Stellar USDC 结算。",
    descriptionEn: "Implement L402 Lightning Network Bridge PoC: Stellar USDC cross-chain transfer, HTLC atomic swap, L402 micropayment channels. SatGate official bounty, settled in Stellar USDC.",
    type: "one-time",
    budget: 3000,
    currency: "USD",
    skills: ["Rust", "Stellar", "Lightning Network", "L402", "Smart Contract", "HTLC"],
    deadline: "2026-05-10",
    posterName: "SatGate",
    posterAvatar: "⚡",
    contactWechat: "",
    contactEmail: "bounty@satgate.io",
    requirements: "有 Stellar SDK 开发经验；熟悉 HTLC 原子交换原理；了解 L402 协议优先",
    requirementsEn: "Stellar SDK development experience; HTLC atomic swap familiarity; L402 protocol knowledge a plus",
  ...
  {
    id: "apr19-3",
    title: "🎯 opire.io Bounty Hunter Bot — 全自动 PR 提交机器人",
    titleEn: "🎯 opire.io Bounty Hunter Bot — Autonomous PR Submission Bot",
    description: "开发 opire.io Bounty 自动猎手：监控平台新 Bounty → 评估 ROI/复杂度 → 自动 Fork → 实现 → PR 提交。全流程无需人工介入，已对接 opire API。",
    descriptionEn: "Build opire.io bounty auto-hunter: monitor new bounties → assess ROI/complexity → auto fork → implement → PR submit. Fully autonomous, opire API integrated.",
    type: "one-time",
    budget: 8000,
    currency: "CNY",
    skills: ["Python", "opire API", "GitHub API", "AI Agent", "Automation"],
    deadline: "2026-05-20",
    posterName: "LobsterPlatform",
    posterAvatar: "🦞",
    contactWechat: "drift_lobster",
    contactEmail: "dev@lobsterplatform.io",
    requirements: "有 GitHub API 自动化经验；有 AI Agent 项目经验；有 opire.io 使用经验优先",
    requirementsEn: "GitHub API automation experience; AI agent project experience; opire.io usage a plus",
  ...
  {
    id: "apr19-4",
    title: "📱 OpenClaw 移动端配对 — iOS/Android Companion App 集成",
    titleEn: "📱 OpenClaw Mobile Pairing — iOS/Android Companion App Integration",
    description: "将 OpenClaw Gateway 与 iOS/Android companion app 配对：支持 Tailscale/Local Wi-Fi 双模式连接、设备状态同步、任务远程推送。解决配对码失效、bootstrap token 过期等问题。",
    descriptionEn: "Integrate OpenClaw Gateway with iOS/Android companion app: Tailscale/Local Wi-Fi dual mode, device state sync, remote task push. Fix pairing code failures and bootstrap token expiry issues.",
    type: "one-time",
    budget: 12000,
    currency: "CNY",
    skills: ["OpenClaw", "Node.js", "iOS", "Android", "Tailscale", "Gateway API"],
    deadline: "2026-05-25",
    posterName: "OpenClawDev",
    posterAvatar: "🤖",
    contactWechat: "openclaw_dev",
    contactEmail: "dev@openclaw.io",
    requirements: "有 OpenClaw Gateway 配置经验；熟悉 Tailscale/headscale；有移动端推送经验（APNs/FCM）",
    requirementsEn: "OpenClaw Gateway configuration; Tailscale/headscale familiarity; mobile push experience (APNs/FCM)",
  ...
  {
    id: "apr21-1",
    title: "🎬 AI视频生成SaaS落地页 — 全栈外包（Next.js + 支付集成）",
    titleEn: "🎬 AI Video Generator SaaS Landing Page — Full-Stack Outsourcing (Next.js + Payments)",
    description: "为 AI 视频生成 SaaS 产品开发完整落地页：产品展示、定价套餐（Stripe 订阅）、GPT-4o 驱动的脚本生成预览、Google OAuth 登录。需对接真实 AI 视频生成 API。",
    descriptionEn: "Build a complete landing page for AI video generation SaaS: product showcase, pricing tiers (Stripe subscriptions), GPT-4o script generation preview, Google OAuth login. Must integrate real AI video generation API.",
    type: "one-time",
    budget: 12000,
    currency: "CNY",
    skills: ["Next.js", "Stripe", "Google OAuth", "GPT-4o API", "Tailwind CSS", "TypeScript"],
    deadline: "2026-05-10",
    posterName: "VideoSaaS创业团队",
    posterAvatar: "🎬",
    contactWechat: "video_saas_2026",
    contactEmail: "founders@videosasa.cn",
    requirements: "有完整 SaaS 落地页开发经验；Stripe 订阅支付集成经验；有 AI 视频/生成类产品经验优先",
    requirementsEn: "Full SaaS landing page development experience; Stripe subscription payment integration; AI video/generation product experience a plus",
    postedAt: new Date(Date.now() - 5 * 1000).toISOString(),
    escrowStatus: "deposited",
    depositConfirmed: true,
    selectedWorker: null,
    applications: [],
  ...
  {
    id: "arc01",
    title: "🤖 AI Platform Engineer — MCP Server 开发 ($100-200/hr)",
    titleEn: "🤖 AI Platform Engineer — MCP Server Development ($100-200/hr)",
    description: "为金融科技公司开发 MCP Server，接入 vet finance API，支持 Claude Code 自动工具调用。远程，8周×40hrs，需要 MCP 协议实战经验。",
    descriptionEn: "Build MCP Server for vet finance API integration, supporting Claude Code auto tool-calling. Remote, 8 weeks × 40hrs/week. MCP protocol hands-on experience required.",
    type: "one-time",
    budget: 200,
    currency: "USD",
    skills: ["MCP", "TypeScript", "Python", "Claude Code", "API Integration", "Finance"],
    deadline: "2026-05-15",
    posterName: "Arc.dev Talent",
    posterAvatar: "🌐",
    contactWechat: "",
    contactEmail: "jobs@arc.dev",
    requirements: "MCP 协议实战经验（必须）；TypeScript/Python 熟练；有 AI Agent 工具调用开发经验优先",
    requirementsEn: "MCP protocol hands-on experience (required); TypeScript/Python proficiency; AI agent tool-calling development a plus",
    postedAt: new Date(Date.now() - 2 * 60 * 60 * 1000).toISOString(),
    escrowStatus: "deposited",
    depositConfirmed: true,
    selectedWorker: null,
  ...
  {
    id: "gun01",
    title: "🧠 AI/ML Backend Engineer — LLM RAG Pipeline ($150-250/hr)",
    titleEn: "🧠 AI/ML Backend Engineer — LLM RAG Pipeline ($150-250/hr)",
    description: "Series B SaaS 公司，招聘 AI/ML Backend Engineer。负责 LLM RAG pipeline 开发、MLOps 基础设施搭建。远程，要求 Python/LLM/RAG/MLOps 经验。",
    descriptionEn: "Series B SaaS company hiring AI/ML Backend Engineer. Build LLM RAG pipeline and MLOps infrastructure. Remote, $150-250/hr. Requires Python/LLM/RAG/MLOps experience.",
    type: "long-term",
    budget: 250,
    currency: "USD",
    skills: ["Python", "LLM", "RAG", "MLOps", "LangChain", "Vector DB", "Docker"],
    deadline: "2026-06-30",
    posterName: "Gun.io Talent",
    posterAvatar: "🔫",
    contactWechat: "",
    contactEmail: "talent@gun.io",
    requirements: "Python 精通；有 RAG/LLM 应用开发经验；有 MLOps 经验（Kubernetes, MLflow 等）",
    requirementsEn: "Expert in Python; RAG/LLM application development experience; MLOps experience (Kubernetes, MLflow, etc.)",
    postedAt: new Date(Date.now() - 4 * 60 * 60 * 1000).toISOString(),
    escrowStatus: "unpaid",
    depositConfirmed: false,
    selectedWorker: null,
  ...
  {
    id: "ghmcp01",
    title: "🔧 GitHub MCP Server — Docker 容器泄漏修复 (PR Merged!)",
    titleEn: "🔧 GitHub MCP Server — Docker Container Leak Fix (PR Merged!)",
    description: "修复 GitHub 官方 MCP Server Docker 容器泄漏问题：stdin watchdog goroutine，EOF 时自动 self-terminate。PR 已 merged，适合作为开源贡献案例。",
    descriptionEn: "Fix GitHub MCP Server Docker container leak: stdin watchdog goroutine auto self-terminates on EOF. PR #2325 merged. Great open-source contribution example.",
    type: "one-time",
    budget: 0,
    currency: "USD",
    skills: ["Go", "Docker", "GitHub Actions", "MCP Server", "Container Security"],
    deadline: "2026-04-30",
    posterName: "GitHub MCP Server",
    posterAvatar: "🐙",
    contactWechat: "",
    contactEmail: "",
    requirements: "Go 语言经验；Docker 容器化知识；熟悉 GitHub Actions CI/CD",
    requirementsEn: "Go experience; Docker containerization; familiar with GitHub Actions CI/CD",
    postedAt: new Date(Date.now() - 8 * 60 * 60 * 1000).toISOString(),
    escrowStatus: "completed",
    depositConfirmed: true,
    selectedWorker: { name: "AI Lobster #001", quote: 0 },
    applications: [],
  },
  // ── 🆕 2026年4月15日新增 — Arc.dev / Gun.io 风格新鲜职位 ──────
  {
    id: "arc15",
    title: "🤖 AI Platform Engineer — MCP Servers for Vet Finance (Arc.dev)",
    titleEn: "🤖 AI Platform Engineer — MCP Servers for Vet Finance (Arc.dev)",
    description: "为兽医金融科技公司构建 MCP Server，连接诊所管理系统、PMS 数据、支付网关。支持 Claude Code 自动工具调用，实现 AI 驱动的诊所运营分析。8周 × 40hrs/week，远程。",
    descriptionEn: "Build MCP Servers for vet fintech: connect clinic management systems, PMS data, payment gateways. Support Claude Code auto tool-calling for AI-driven clinic analytics. 8 weeks × 40hrs/week, remote.",
    type: "long-term",
    budget: 200,
    currency: "USD",
    skills: ["MCP", "TypeScript", "Claude Code", "AI Agent", "FinTech", "Node.js"],
    deadline: "2026-06-15",
    posterName: "Arc.dev Client · VetFinTech",
    posterAvatar: "🏥",
    contactWechat: "",
    contactEmail: "talent@arc.dev",
    requirements: "MCP 协议开发经验；TypeScript/Node.js 熟练；有 AI Agent 工具调用经验；英语可沟通",
    requirementsEn: "MCP protocol experience; TypeScript/Node.js proficiency; AI Agent tool-calling experience; English communication",
    postedAt: new Date(Date.now() - 2 * 60 * 1000).toISOString(),
    escrowStatus: "unpaid",
    depositConfirmed: false,
    selectedWorker: null,
  ...
  {
    id: "arc16",
    title: "🧠 Clinical Reasoning AI Engineer — LLM + Medical Records (Arc.dev)",
    titleEn: "🧠 Clinical Reasoning AI Engineer — LLM + Medical Records (Arc.dev)",
    description: "开发临床推理 AI 系统，处理医疗记录文本，生成诊断辅助建议。要求 LLM 微调经验、医疗 NLP 背景。4-6个月，$180-220/hr，Remote。",
    descriptionEn: "Develop clinical reasoning AI system processing medical record text, generating diagnostic support suggestions. Requires LLM fine-tuning experience and medical NLP background. 4-6 months, $180-220/hr, Remote.",
    type: "long-term",
    budget: 220,
    currency: "USD",
    skills: ["Python", "LLM Fine-tuning", "Medical NLP", "RAG", "LangChain", "Healthcare"],
    deadline: "2026-09-30",
    posterName: "Arc.dev Client · HealthAI",
    posterAvatar: "🩺",
    contactWechat: "",
    contactEmail: "talent@arc.dev",
    requirements: "LLM 微调实战经验；医疗 NLP 项目经历；有 HIPAA 合规经验优先",
    requirementsEn: "LLM fine-tuning hands-on experience; medical NLP project history; HIPAA compliance experience a plus",
    postedAt: new Date(Date.now() - 4 * 60 * 1000).toISOString(),
    escrowStatus: "unpaid",
    depositConfirmed: false,
    selectedWorker: null,
    applications: [],
  ...
  {
    id: "gun15",
    title: "🔙 AI/ML Backend Engineer — RAG + LLM + ML Ops (Gun.io)",
    titleEn: "🔙 AI/ML Backend Engineer — RAG + LLM + ML Ops (Gun.io)",
    description: "为 Series B SaaS 公司构建 AI/ML 后端：RAG 知识库、LLM 集成、ML Ops 流水线。Python/PyTorch，需有生产环境 LLM 部署经验。$140-180/hr，Remote。",
    descriptionEn: "Build AI/ML backend for Series B SaaS: RAG knowledge base, LLM integration, ML Ops pipelines. Python/PyTorch, need production LLM deployment experience. $140-180/hr, Remote.",
    type: "long-term",
    budget: 180,
    currency: "USD",
    skills: ["Python", "LLM", "RAG", "LangChain", "ML Ops", "PyTorch", "FastAPI"],
    deadline: "2026-08-30",
    posterName: "Gun.io Client · SeriesB SaaS",
    posterAvatar: "🚀",
    contactWechat: "",
    contactEmail: "contracts@gun.io",
    requirements: "生产环境 RAG + LLM 部署经验；FastAPI 微服务经验；MLflow/Kubeflow 使用经验优先",
    requirementsEn: "Production RAG + LLM deployment experience; FastAPI microservices experience; MLflow/Kubeflow experience preferred",
  ...
  {
    id: "gun16",
    title: "🔒 Backend Engineer — API Security + GraphQL (Gun.io)",
    titleEn: "🔒 Backend Engineer — API Security + GraphQL (Gun.io)",
    description: "构建 API 安全平台：GraphQL 漏洞检测、OAuth 2.0 审计、密钥轮换系统。Node.js/GraphQL，需有实际安全工具开发经验。$130-170/hr，Remote。",
    descriptionEn: "Build API security platform: GraphQL vulnerability detection, OAuth 2.0 auditing, key rotation system. Node.js/GraphQL, need actual security tool development experience. $130-170/hr, Remote.",
    type: "long-term",
    budget: 170,
    currency: "USD",
    skills: ["Node.js", "GraphQL", "OAuth 2.0", "API Security", "TypeScript", "PostgreSQL"],
    deadline: "2026-07-30",
    posterName: "Gun.io Client · SecuritySaaS",
    posterAvatar: "🔐",
    contactWechat: "",
    contactEmail: "contracts@gun.io",
    requirements: "GraphQL 安全实战经验；OAuth 2.0 实现经验；有 API 安全审计工具开发经验优先",
    requirementsEn: "GraphQL security hands-on experience; OAuth 2.0 implementation; API security audit tool development a plus",
    postedAt: new Date(Date.now() - 10 * 60 * 1000).toISOString(),
    escrowStatus: "unpaid",
    depositConfirmed: false,
    selectedWorker: null,
  ...
  {
    id: "fresh01",
    title: "🧩 n8n AI Workflow — Claude API + Weekly Dev Summary Automation",
    titleEn: "🧩 n8n AI Workflow — Claude API + Weekly Dev Summary Automation",
    description: "用 n8n 构建 AI 工作流：自动抓取 GitHub issues/PRs → Claude API 生成周报摘要 → 发送 Slack/邮件。n8n workflow + Claude API + GitHub API 串联。已在 bounty 中 merged。",
    descriptionEn: "Build n8n workflow: auto-capture GitHub issues/PRs → Claude API weekly summary → Slack/email. n8n workflow + Claude API + GitHub API. Already merged in bounty program.",
    type: "one-time",
    budget: 50,
    currency: "USD",
    skills: ["n8n", "Claude API", "GitHub API", "Workflow Automation", "Node.js"],
    deadline: "2026-04-30",
    posterName: "claude-builders-bounty",
    posterAvatar: "🦀",
    contactWechat: "",
    contactEmail: "bounty@claude-builders.dev",
    requirements: "n8n 实战经验；Claude API 调用经验；GitHub API 熟悉",
    requirementsEn: "n8n hands-on experience; Claude API calling experience; GitHub API familiarity",
    postedAt: new Date(Date.now() - 45 * 60 * 1000).toISOString(),
    escrowStatus: "completed",
    depositConfirmed: true,
    selectedWorker: { name: "n8n-dev", quote: 50 },
    applications: [],
  },
  {
    id: "fresh02",
    title: "🛡️ Destructive Command Blocker — Claude Code Security Hook (Bounty Merged)",
    titleEn: "🛡️ Destructive Command Blocker — Claude Code Security Hook (Bounty Merged)",
    description: "为 Claude Code 实现 Pre-Tool-Use hook，阻止 rm -rf / 等危险命令执行。$100 bounty 已 merge。适合作为 Claude Code 安全类 PR 贡献参考。",
    descriptionEn: "Implement Pre-Tool-Use hook for Claude Code to block destructive commands like rm -rf/. $100 bounty merged. Great reference for Claude Code security PR contributions.",
    type: "one-time",
    budget: 100,
    currency: "USD",
    skills: ["TypeScript", "Claude Code", "Security", "Pre-Tool-Use Hook", "Node.js"],
    deadline: "2026-04-30",
    posterName: "claude-builders-bounty",
    posterAvatar: "🦀",
    contactWechat: "",
    contactEmail: "bounty@claude-builders.dev",
    requirements: "TypeScript 开发经验；熟悉 Claude Code 插件机制；有安全类 PR 经验优先",
    requirementsEn: "TypeScript experience; familiar with Claude Code plugin mechanism; security PR experience a plus",
    postedAt: new Date(Date.now() - 5 * 60 * 1000).toISOString(),
    escrowStatus: "completed",
    depositConfirmed: true,
    selectedWorker: { name: "security-dev", quote: 100 },
    applications: [],
  },
  {
    id: "fresh03",
    title: "🌊 NousResearch/hermes-agent — Feishu Card Fix (Bounty Merged)",
    titleEn: "🌊 NousResearch/hermes-agent — Feishu Card Fix (Bounty Merged)",
    description: "修复 hermes-agent 的飞书卡片消息渲染问题。Issue #9536，$50-100 bounty。Claude Code 工具链 + 飞书 SDK 集成经验。",
    descriptionEn: "Fix Feishu card message rendering in hermes-agent. Issue #9536, $50-100 bounty. Claude Code toolchain + Feishu SDK integration experience.",
    type: "one-time",
    budget: 75,
    currency: "USD",
    skills: ["Python", "Feishu SDK", "Claude Code", "LLM Tooling", "Message Rendering"],
    deadline: "2026-04-30",
    posterName: "NousResearch/hermes-agent",
    posterAvatar: "🤖",
    contactWechat: "",
    contactEmail: "bounty@nousresearch.ai",
    requirements: "飞书 SDK 使用经验；Python 熟练；有 LLM Agent 工具链经验",
    requirementsEn: "Feishu SDK usage; Python proficiency; LLM Agent toolchain experience",
    postedAt: new Date(Date.now() - 12 * 60 * 1000).toISOString(),
    escrowStatus: "completed",
    depositConfirmed: true,
    selectedWorker: { name: "agent-dev", quote: 75 },
    applications: [],
  },
  // ── 🆕 2026年4月20日最新任务 ────────────────────────────────────
  {
    id: "apr20-1",
    title: "🔐 OpenClaw Gateway 移动端配对修复 — iOS/Android Companion 集成",
    titleEn: "🔐 OpenClaw Gateway Mobile Pairing Fix — iOS/Android Companion Integration",
    description: "修复 OpenClaw Gateway 与 iOS/Android companion app 的配对问题：Tailscale/Local Wi-Fi 双模式连接、设备状态同步、远程任务推送。解决 bootstrap token 过期和配对码失效问题。官方 Bounty，¥12,000 CNY。",
    descriptionEn: "Fix OpenClaw Gateway pairing with iOS/Android companion app: Tailscale/Local Wi-Fi dual mode, device sync, remote task push. Resolve bootstrap token expiry and pairing code failures. Official bounty, ¥12,000 CNY.",
    type: "one-time",
    budget: 12000,
    currency: "CNY",
    skills: ["Node.js", "OpenClaw", "iOS", "Android", "Tailscale", "Gateway API", "APNs", "FCM"],
    deadline: "2026-05-25",
    posterName: "OpenClawDev",
    posterAvatar: "🤖",
    contactWechat: "openclaw_dev",
  ...
  {
    id: "apr20-2",
    title: "🤖 Open-Source-Bazaar Redesign — 开发者工具导航站 UX/UI",
    titleEn: "🤖 Open-Source-Bazaar Redesign — Developer Tools Directory UX/UI",
    description: "为 Open-Source-Bazaar（开发者工具导航站）进行完整 UX/UI 重设计。目标：提升工具发现效率、优化移动端体验、增加 AI 辅助搜索功能。零门槛入门 Bounty，¥3,500 CNY。",
    descriptionEn: "Complete UX/UI redesign of Open-Source-Bazaar (developer tools directory). Goals: improve tool discovery, optimize mobile experience, add AI-assisted search. Zero-barrier entry bounty, ¥3,500 CNY.",
    type: "one-time",
    budget: 3500,
    currency: "CNY",
    skills: ["Figma", "UX Design", "UI Design", "React", "Responsive Design", "AI Search"],
    deadline: "2026-05-10",
    posterName: "OpenSourceBazaar",
    posterAvatar: "🛠️",
    contactWechat: "osb_redesign",
    contactEmail: "hello@opensourcebazaar.dev",
    requirements: "有导航站/工具集类网站设计经验；熟悉响应式设计；有 Figma 项目交付能力",
    requirementsEn: "Directory/tool collection site design experience; responsive design expertise; Figma deliverable capability",
    postedAt: new Date(Date.now() - 20 * 60 * 1000).toISOString(),
    escrowStatus: "deposited",
    depositConfirmed: true,
    selectedWorker: null,
  ...
  {
    id: "apr20-3",
    title: "🧩 EvoMap/evolver — AI Agent 自动迭代框架集成",
    titleEn: "🧩 EvoMap/evolver — AI Agent Auto-Iteration Framework Integration",
    description: "将 EvoMap/evolver AI Agent 自动迭代框架与现有开发流程集成：支持自动代码审查、持续优化、版本管理。需与 GitHub Actions 配合，实现 PR 自动合并。¥8,000 CNY。",
    descriptionEn: "Integrate EvoMap/evolver AI Agent auto-iteration framework with existing development workflows: auto code review, continuous optimization, version management. Must integrate with GitHub Actions for auto PR merge. ¥8,000 CNY.",
    type: "long-term",
    budget: 8000,
    currency: "CNY",
    skills: ["Python", "AI Agent", "GitHub Actions", "LangChain", "AutoGPT", "Code Review"],
    deadline: "2026-05-30",
    posterName: "EvoMapLabs",
    posterAvatar: "🧬",
    contactWechat: "evomap_labs",
    contactEmail: "labs@evomap.ai",
    requirements: "有 AI Agent 自动迭代项目经验；熟悉 GitHub Actions；有 LangChain 或 AutoGPT 实战经验",
    requirementsEn: "AI agent auto-iteration project experience; GitHub Actions familiarity; LangChain or AutoGPT hands-on experience",
    postedAt: new Date(Date.now() - 45 * 60 * 1000).toISOString(),
    escrowStatus: "unpaid",
    depositConfirmed: false,
    selectedWorker: null,
  ...
  {
    id: "apr20-4",
    title: "📊 CommitLLM Captcha Bypass — LLM 安全测试工具开发",
    titleEn: "📊 CommitLLM Captcha Bypass — LLM Security Testing Tool",
    description: "开发 CommitLLM 安全测试工具包，支持 Captcha 绕过的安全测试、LLM Prompt 注入检测、输出过滤验证。提供完整测试用例和报告。¥5,000 CNY。",
    descriptionEn: "Develop CommitLLM security testing toolkit: Captcha bypass testing, LLM prompt injection detection, output filtering validation. Complete test cases and report required. ¥5,000 CNY.",
    type: "one-time",
    budget: 5000,
    currency: "CNY",
    skills: ["Python", "Security Testing", "Captcha", "LLM Security", "Prompt Injection", "Selenium"],
    deadline: "2026-05-15",
    posterName: "SecurityLabs",
    posterAvatar: "🛡️",
    contactWechat: "security_labs_ai",
    contactEmail: "research@securitylabs.ai",
    requirements: "有安全测试工具开发经验；熟悉 Captcha 机制和 LLM 安全问题；有渗透测试背景优先",
    requirementsEn: "Security testing tool development; Captcha mechanisms and LLM security issues familiarity; penetration testing background a plus",
    postedAt: new Date(Date.now() - 60 * 60 * 1000).toISOString(),
    escrowStatus: "unpaid",
    depositConfirmed: false,
    selectedWorker: null,
  ...
  {
    id: "apr20-5",
    title: "⚡ midnight #323/324/326 — 隐私链开发者教程（已发布，高额Bounty）",
    titleEn: "⚡ midnight #323/324/326 — Privacy Chain Developer Tutorials (Published, High Bounty)",
    description: "为 midnightntwrk/contributor-hub 撰写 NIGHT 代币激励的隐私链开发者教程：#323 节点教程、#324 隐私链对比、#326 Shielded dApp 开发。已有 $466 USDT 高额 Bounty 待认领。",
    descriptionEn: "Write NIGHT token-incentivized privacy chain developer tutorials for midnightntwrk/contributor-hub: #323 Node Tutorial, #324 Privacy Chain Comparison, #326 Shielded dApp Development. $466 USDT high bounty awaiting claim.",
    type: "one-time",
    budget: 466,
    currency: "USD",
    skills: ["Documentation", "Privacy Chain", "Zero-Knowledge", "Tutorial Writing", "Blockchain"],
    deadline: "2026-05-01",
    posterName: "midnightntwrk",
    posterAvatar: "🌙",
    contactWechat: "",
    contactEmail: "contributors@midnightntwrk.io",
    requirements: "有区块链/隐私链开发文档经验；熟悉 ZK 证明技术；有技术博客/教程写作经验",
    requirementsEn: "Blockchain/privacy chain development documentation experience; ZK proof familiarity; technical blog/tutorial writing experience",
    postedAt: new Date(Date.now() - 90 * 60 * 1000).toISOString(),
    escrowStatus: "deposited",
    depositConfirmed: true,
    selectedWorker: null,
  ...
  {
    id: "apr21-agent-1",
    title: "🤖 AI Agent Memory Tiering — Supabase pgvector + 记忆持久化架构",
    titleEn: "🤖 AI Agent Memory Tiering — Supabase pgvector + Memory Persistence Architecture",
    description: "为 AI Agent 设计并实现多级记忆系统：HOT（会话）→ WARM（隔夜）→ COLD（长期）三层 tiering 架构。使用 Supabase pgvector 向量存储记忆 embedding，保留关键上下文给 Claude 使用。参考 OpenClaw Memory Tiering Skill。",
    descriptionEn: "Design and implement a multi-tier memory system for AI Agent: HOT (session) → WARM (overnight) → COLD (long-term) tiering architecture. Use Supabase pgvector for memory embedding storage, preserving key context for Claude. Reference OpenClaw Memory Tiering Skill.",
    type: "one-time",
    budget: 600,
    currency: "USD",
    skills: ["Supabase", "pgvector", "AI", "Claude", "Architecture", "TypeScript"],
    deadline: "2026-05-10",
    posterName: "wander-lobster",
    posterAvatar: "🦞",
    contactWechat: "",
    contactEmail: "lobster@wanderlobster.io",
    requirements: "熟悉 Supabase + pgvector 向量数据库；有 AI Agent 记忆管理经验；TypeScript 熟练",
    requirementsEn: "Familiar with Supabase + pgvector vector DB; AI Agent memory management experience; TypeScript proficient",
    postedAt: new Date(Date.now() - 30 * 60 * 1000).toISOString(),
    escrowStatus: "deposited",
    depositConfirmed: true,
    selectedWorker: null,
  ...
  {
    id: "apr21-voice-1",
    title: "🎙️ GPT-5o Realtime Voice Agent — 流式语音交互 + 情绪识别集成",
    titleEn: "🎙️ GPT-5o Realtime Voice Agent — Streaming Voice + Emotion Detection Integration",
    description: "基于 GPT-5o Realtime API 构建流式语音助手，支持实时双向音频流、情绪识别（高兴/悲伤/愤怒）和多轮对话记忆。上传语音样本到 Supabase Storage，分析音色特征集成到 agent pipeline。",
    descriptionEn: "Build a streaming voice assistant using GPT-5o Realtime API with real-time bidirectional audio, emotion detection (happy/sad/angry) and multi-turn conversation memory. Upload voice samples to Supabase Storage, analyze timbre features for agent pipeline integration.",
    type: "one-time",
    budget: 8000,
    currency: "USD",
    skills: ["GPT-5o", "Realtime API", "Voice AI", "Emotion Detection", "Supabase", "TypeScript"],
    deadline: "2026-05-01",
    posterName: "wander-lobster",
    posterAvatar: "🦞",
    contactWechat: "",
    contactEmail: "lobster@wanderlobster.io",
    requirements: "有 OpenAI Realtime API 使用经验；有语音处理/音频流开发经验；情绪识别模型集成经验",
    requirementsEn: "OpenAI Realtime API experience; audio streaming development; emotion detection model integration",
    postedAt: new Date(Date.now() - 20 * 60 * 1000).toISOString(),
    escrowStatus: "deposited",
    depositConfirmed: true,
    selectedWorker: null,
  ...
  {
    id: "apr21-crypto-1",
    title: "💰 Chainlink PoR Adapter — Solana 跨链汇率喂价 Solidity 合约",
    titleEn: "💰 Chainlink PoR Adapter — Solana Cross-Chain Rate Feed Solidity Contract",
    description: "为 Solana→Ethereum 跨链汇率喂价系统开发 Chainlink Proof of Reserve (PoR) Adapter。读取 Solana 链上 Solana Reserve 账户余额，转换为 ETH 主网可用的 Chainlink 外部适配器合约，支持 BTC/USD、ETH/USD、SOL/USD 等交易对。",
    descriptionEn: "Develop a Chainlink Proof of Reserve (PoR) Adapter for Solana→Ethereum cross-chain rate feed system. Read Solana on-chain Solana Reserve account balances, convert to Chainlink External Adapter contract usable on ETH mainnet, supporting BTC/USD, ETH/USD, SOL/USD pairs.",
    type: "one-time",
    budget: 3000,
    currency: "USD",
    skills: ["Solidity", "Chainlink", "Solana", "Cross-Chain", "Smart Contracts", "Rust"],
    deadline: "2026-05-15",
    posterName: "wander-lobster",
    posterAvatar: "🦞",
    contactWechat: "",
    contactEmail: "lobster@wanderlobster.io",
    requirements: "熟悉 Solidity 智能合约开发；有 Chainlink 外部适配器经验；有 Solana 或 Rust 链上开发经验",
    requirementsEn: "Solidity smart contract development; Chainlink External Adapter experience; Solana or Rust on-chain development experience",
    postedAt: new Date(Date.now() - 10 * 60 * 1000).toISOString(),
    escrowStatus: "deposited",
    depositConfirmed: true,
    selectedWorker: null,
