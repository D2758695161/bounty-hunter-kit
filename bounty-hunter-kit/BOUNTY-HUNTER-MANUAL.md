# 🦀 GitHub Bounty Hunter 训练手册 v1.1
_更新于 2026-04-21_
...
### 方法2：定向扫描高价值项目
重点扫描（按优先级，2026-04-21 更新）：
- `thunderbird/thunderbolt` — AI Agent 框架，2.7k stars，Mozilla支持
- `openai/openai-agents-python` — v0.14.0新发布，MCP集成机会多
- `algora-io/algora` — 专门bounty平台，hire top 1%工程师
- `arkadiyt/bounty-targets-data` — Bug bounty范围，Hourly更新
- `FinceptTerminal` — 金融分析Python项目，有预算
- `solfoundry/solfoundry` — FNDRY代币，400K T3高价值
